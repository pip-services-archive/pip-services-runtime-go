...
func NewDummyDataAccessFixture(dbRef IDummyDataAccess) *DummyDataAccessFixture {
    return &DummyDataAccessFixture { db: dbRef }    
}

var DUMMY1 *Dummy = NewDummy("", "Key 1", "Content 1")
var DUMMY2 *Dummy = NewDummy("", "Key 2", "Content 2")
